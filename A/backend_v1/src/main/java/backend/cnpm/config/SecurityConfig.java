package backend.cnpm.config;

import backend.cnpm.security.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/customers/**").hasAnyRole("ADMIN", "STAFF")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/vouchers/**", "/api/brand/**", "/api/material/**",
                                ...
                                "/api/sizes/**", "/api/sleeve/**", "/api/promotion/**")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/vouchers/**", "/api/brand/**", "/api/material/**",
                                "/api/categories/**", "/api/colors/**", "/api/collars/**",
                                "/api/sizes/**", "/api/sleeve/**", "/api/promotion/**", "/api/customers/**")
                        .hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/products/**", "/api/product-details/**")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/products/**", "/api/product-details/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/products/**", "/api/product-details/**")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/products/**", "/api/product-details/**")
                        .hasRole("ADMIN")
