...
import backend.cnpm.dto.request.ProductCreateRequest;
import backend.cnpm.dto.request.ProductUpdateRequest;
import backend.cnpm.dto.response.ProductDetailResponse;
import backend.cnpm.dto.response.ProductResponse;
...
import backend.cnpm.mapper.ProductDetailMapper;
import backend.cnpm.mapper.ProductMapper;
...
public class ProductService {
        ...
        public Page<UserProductResponse> getAllProductUser(
                ...
                List<String> allowedSortFields = List.of("id", "productName", "quantity", "minPrice");
