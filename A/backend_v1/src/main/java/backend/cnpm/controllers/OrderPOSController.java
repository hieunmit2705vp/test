...
import backend.cnpm.services.OrderPOSService;
...
public class OrderPOSController {
    ...
    public ResponseEntity<ApiResponse> getAllPOSOrders(
        ...
        try {
            ...
            Page<OrderPOSResponse> orderPOSResponsePage = orderPOSService.getAllPOSOrders(search, status, page, size, sortKey, sortDirection);
